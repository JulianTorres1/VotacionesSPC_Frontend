...
import ColegioLogo from "./media/img/ColegioLogo.png";

import axios from "axios";
import Status from "./Status.tsx";
import sena from "./media/img/logoSena.png";
import bgImage from "./media/img/estudiantes.jpg";
...
function App() {
  ...
  const handleVote = (candidateId: string) => {
    ...
    axios
      .post(`${API_URL}/create`, { id_candidato: candidateId })
      .then(() => {
                            ...
                            .map((candidate) => (
                              <div
                                ...
                                className={`${getCardBackgroundColor(
                                  candidate.nombre
                                )} rounded-lg shadow-md overflow-hidden border-2 border-secondary-yellow`}
                              >
